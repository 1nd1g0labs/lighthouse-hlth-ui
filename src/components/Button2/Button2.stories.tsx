...
/**
 * Button2 - Framer-aligned button with animated arrow hover effect
 *
...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Primary interactive button with animated arrow hover effect. Framer-aligned replacement for Button component. Matches marketing site exactly (nodeId: Jobckk162).',
      },
    },
  },
  tags: ['autodocs'],
...
export const VariantComparison: Story = {
  render: () => (
    <div className="flex flex-col gap-4">
      <Button2 variant="green-right">Green Right (default)</Button2>
      <Button2 variant="green-left">Green Left</Button2>
      <Button2 variant="white-right">White Right</Button2>
      <Button2 variant="white-left">White Left</Button2>
      <Button2 variant="white-static">White Static (no animation)</Button2>
    </div>
  ),
  parameters: {
    docs: {
  ...
  render: () => (
    <div className="max-w-4xl p-12 bg-gradient-to-r from-primary-500 to-primary-600 rounded-lg text-white">
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        <Button2 variant="white-right">Schedule a Demo</Button2>
        <Button2 variant="white-static">Learn More</Button2>
      </div>
    </div>
  ),
  parameters: {
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl">
      {[
        ...
        <div key={i} className="p-6 bg-white rounded-lg shadow-md">
          ...
          <Button2 variant="green-right">{feature.cta}</Button2>
        </div>
      ))}
    </div>
  ),
  ...
  render: () => (
    <div className="max-w-md p-8 bg-white rounded-lg shadow-lg">
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <Button2 variant="green-right" className="flex-1">
          Schedule Demo
        </Button2>
        <Button2 variant="white-static" className="flex-1">
          Cancel
        </Button2>
      </div>
    </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl">
      {[
        ...
        >
          ...
          <Button2 variant={tier.variant} className="w-full">
            {tier.cta}
          </Button2>
        </div>
      ))}
  ...
  render: () => (
    <div className="max-w-md p-6 bg-white rounded-lg shadow-xl">
      ...
      <div className="flex justify-end gap-3">
        <Button2 variant="white-static">Cancel</Button2>
        <Button2 variant="green-right">Delete Report</Button2>
      </div>
    </div>
  ),
  parameters: {
...
export const AccessibilityDemo: Story = {
  render: () => (
    <div className="flex flex-col gap-6 max-w-2xl">
      ...
      <div className="flex flex-col gap-4 p-4 bg-neutral-50 rounded">
        ...
        <Button2 variant="green-right">Keyboard Accessible</Button2>
      </div>
      ...
      <div className="flex flex-col gap-4 p-4 bg-neutral-50 rounded">
        ...
        <Button2 variant="white-right">Focus Me</Button2>
      </div>
      ...
      <div className="flex flex-col gap-4 p-4 bg-neutral-50 rounded">
        ...
        <Button2 variant="green-right" disabled>
          Disabled Button
        </Button2>
      </div>
    </div>
  ...
  parameters: {
    docs: {
      description: {
        story: 'Demonstrates accessibility features ensuring Button2 is usable by all users.',
      },
    },
  },
};
