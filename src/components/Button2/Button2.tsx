...
/**
 * Button2 Component - Framer Aligned (nodeId: Jobckk162)
 *
 * Primary interactive button with animated arrow hover effect. This is the
 * Framer-aligned replacement for the existing Button component, offering
 * the exact visual design from the marketing site.
 *
 ...
 * <Button2 variant="white-right">Learn More</Button2>
 *
 * // As a link
 * <Button2 href="/signup" variant="green-left">
 *   Sign Up Now
 * </Button2>
 *
 * // Disable animation
 * <Button2 variant="white-static">Simple Button</Button2>
 *
 * // Disabled state
 * <Button2 disabled>Unavailable</Button2>
 * ```
 */
...
/**
 * Button2 - Framer-aligned button with animated arrow
 *
    ...
    if (href) {
      ...
      return (
        <motion.a
          ...
          href={href}
          className={cn(button2Variants({ variant, className }))}
          initial="initial"
